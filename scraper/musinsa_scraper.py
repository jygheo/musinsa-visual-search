...
def get_page_info(cur, conn, page_num=1):
        ...
        if match:
            ...
            try:
                ...
                for goods_dict in goods_info_list:
                    prod_num, prod_name, brand_name, price = goods_dict["goodsNo"], goods_dict[
                        "goodsName"], goods_dict["brandName"], goods_dict["price"]
